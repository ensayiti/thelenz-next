...
const Navbar = () => {
  ...
  return (
    <div style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
        ...
        <Link href='/'>
        <h1 style={{color: `${textColor}`}} className='font-bold text-4xl'>The Lenz</h1>
        </Link>
            ...
            : 'sm:hidden absolute top-0 left-[-100%] right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in'}>
            <ul>
